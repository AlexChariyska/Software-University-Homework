function processRestaurantManagerCommands(commands) {
    ...
    Object.prototype.validationNotEmptyString = function (value, variableName) {
    ...
    Object.prototype.validateNumberInRange = function (value, variableName, max) {
    ...
    var RestaurantEngine = (function () {
        ...
        var Restaurant = (function () {
            ...
            Restaurant.prototype.setName = function (name) {
                this.validationNotEmptyString(name, 'Restaurant name');
                this._name = name;
            };
            ...
            Restaurant.prototype.setLocation = function (location) {
                this.validationNotEmptyString(location, 'Restaurant location');
        ...
        var Recipe = (function () {
            function Recipe(name, price, calories, quantity, unitForMeasurement, timeToPrepare) {
                ...
                this.setUnitForMeasurement(unitForMeasurement);
                this.setTimeToPrepare(timeToPrepare);
            }
            
            Recipe.prototype.setName = function (name) {
                this.validationNotEmptyString(name, 'Recipe name');
                this._name = name;
            };
            ...
            Recipe.prototype.setPrice = function (price) {
                this.validatePositiveNumber(price, "Recipe price");
                this._price = price;
            };
            ...
            Recipe.prototype.setCalories = function (calories) {
                this.validatePositiveNumber(calories, "Recipe calories");
            ...
            Recipe.prototype.setQuantity = function (quantity) {
                this.validatePositiveNumber(quantity, "Recipe quantity");
            ...
            Recipe.prototype.setUnitForMeasurement = function (unitForMeasurement) {
                
                this._unitForMeasurement = unitForMeasurement;
            };

            Recipe.prototype.getUnitForMeasurement = function () {
                return this._unitForMeasurement;
            };
            
            Recipe.prototype.setTimeToPrepare = function (timeToPrepare) {
                this.validatePositiveNumber(timeToPrepare, "Recipe timeToPrepare");
            ...
            Recipe.prototype.toString = function () {
                return "==  " + this.getName()+ " == $" + this.getPrice().toFixed(2) + "\n" +
                       "Per serving: " + this.getQuantity() + " " + this.getUnitForMeasurement() + ", " + this.getCalories() + " kcal" + "\n" +
        ...
        var Drink = (function () {
            var UNIT_FOR_MEASURE_DRINK = "ml";
            function Drink(name, price, calories, quantity, timeToPrepare, isCarbonated) {
                
                validateNumberInRange(calories, "Drink calories", 100);
                validateNumberInRange(Number(timeToPrepare), "Drink timeToPrepare", 20);
                
                Recipe.call(this, name, price, calories, quantity, UNIT_FOR_MEASURE_DRINK, timeToPrepare);
                this.setIsCarbonated(isCarbonated);
            }            
            
            Drink.extends(Recipe);
            
            Recipe.prototype.setIsCarbonated = function (isCarbonated) {
                
                this._isCarbonated = isCarbonated;
            };

            Recipe.prototype.getIsCarbonated = function () {
        ...
        var Salad = (function () {
            ...
            function Salad(name, price, calories, quantity, timeToPrepare, containsPasta) {
                Meal.call(this, name, price, calories, quantity, timeToPrepare, IS_VEGAN);
