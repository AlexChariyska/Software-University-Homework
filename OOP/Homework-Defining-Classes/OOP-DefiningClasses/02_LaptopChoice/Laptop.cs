...
class Laptop
{
    ...
    public string Manufacturer
    {
        ...
        set
        {
            this.Validation(value, "manufacturer");
    ...
    public string Processor
    {
        ...
        set
        {
            this.Validation(value, "processor");
    ...
    public string GraphicsCard
    {
        ...
        set
        {
            this.Validation(value, "graphicsCard");
    ...
    public decimal Price
    {
        ...
        set
        {
            if (value < 0)
            {
                throw new ArgumentException("Invalid input. Price must be positive");
            }
            this.price = value;
        }
    }
    ...
    public Laptop(string model, string manufacturer, string processor, string ram, string graphicsCard, string hdd, string screen, string batteryDescription, double batteryLifeInHours, decimal price)
    {
        this.Model = model;
    ...
    public Laptop(string model, string ram, string hdd, string screen, decimal price) :
        this(
            model: model,
            manufacturer: null,
            processor: null,
    ...
    private void Validation(object data, string argument)
    {
        if (data is string)
        {
            if ((string)data == "")
